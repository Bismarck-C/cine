...
int main() {
	...
	do {
		...
		case 3:
			...
			system("cls");
			if (sala == 1 && ptrCinema->getSala1() != NULL && activador == 1) {
				if (ptrCinema->getSala1()->getFuncion(activador - 1)->getTanda() == "manana") {
					if (ptrCinema->getSala1()->getFuncion(activador - 1) != NULL) {
			...
			else if (sala == 1 && ptrCinema->getSala1() != NULL && activador == 2) {
			...
			else if (sala == 1 && ptrCinema->getSala1() != NULL && activador == 3) {
			...
			//sala 2
			if (sala == 2 && ptrCinema->getSala2() != NULL && activador == 1) {

				if (ptrCinema->getSala2()->getFuncion(activador - 1)->getTanda() == "manana") {
					if (ptrCinema->getSala2()->getFuncion(activador - 1) != NULL) {
			...
			else if (sala == 2 && ptrCinema->getSala2() != NULL && activador == 2) {
			...
			else if (sala == 2 && ptrCinema->getSala2() != NULL && activador == 3) {
